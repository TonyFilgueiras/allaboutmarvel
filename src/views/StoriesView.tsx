...
export default React.memo(function ComicsView() {
  ...
  const { typingText, setTypingText, apiOffset, setApiOffset, disableFirstRender, setDisableFirstRender, fetchData, loading, data, error } = React.useContext(StoriesDataContext)
